...
|---|---|---|
| "What is / How to" dominate | Informational | Comprehensive guide/explainer |
...
Fill in the content brief template (see `templates/content-brief-template.md`). The brief defines:
...
- [ ] Intro doesn't start with a cliche
...
- **Intent mismatch** — If the planned angle doesn't match search intent (e.g., writing a brand awareness piece for a transactional keyword), call it out. The piece will get traffic that doesn't convert.
...
| Readability audit | Specific sentence-level edits flagged with fixes |
...
- **bycrawl-seo-blog-production**: Use when you want social data from bycrawl to enrich any phase of content production.
- **bycrawl-content-research**: Use for social-first content gap analysis before briefing.
- **bycrawl-copy-intelligence**: Use for audience language mining to inform drafting.
- **bycrawl-social-keyword-signals**: Use for trending keyword discovery from social platforms.
